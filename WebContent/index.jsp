...
<body>
	...
	<div class="row">
		<div class="col-sm-3">
			...
			<div class="col-sm-7">
				<!-- Miste dÃ©roulant des responsable-->
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="#" onClick="ajax_loader('Gates')">Monsieur
								Bill Gates</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">Responsable Système
							d'embarquement</li>
						<li><a href="#" onClick="ajax_loader('Hugo')">Monsieur
								Victor Hugo</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">Responsable Réseau</li>
						<li><a href="#" onClick="ajax_loader('Bulo')">Madame
								Marie bulo</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">Responsable Business Intelligent</li>
						<li><a href="#" onClick="ajax_loader('Intelligis')">Madame
								Anne-laure Intelligis</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">Responsable Numérique et Santé</li>
						<li><a href="#" onClick="ajax_loader('Kate')">Madame
								Greys Kate</a></li>
					</ul>
				</div>
			</div>
						...
						<div class="well well-sm" id="nom_respo2">
							<div class="row">
								...
								<div class="col-sm-6 col-md-8">
									<h4>
										<span id="libelle">Monsieur Bill Gates</span>
									</h4>
									<br /> <small><cite title="SystÃ©me d'information"><i
									...
									<p>
										<c:if test="${!empty sessionScope.session_utilisateur}">
											...
											<i class="glyphicon glyphicon-envelope"></i>&nbsp; <span
												id="email">bill.gates@isep.fr </span>
											<br />
										</c:if>
